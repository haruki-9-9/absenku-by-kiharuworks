...
import { tambahTahunAjaranAction } from "../actions";
import Link from "next/link";

const initialState = { success: false, message: "" };

export default function TambahTahunAjaranForm() {
  const [state, formAction, isPending] = useActionState(tambahTahunAjaranAction, initialState);

  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 480 }}>
      <div>
        <Link href="/admin/tahun-ajaran" style={{
