    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 640 }}>
      <div>
        ...
        <p style={{ fontSize: 13, color: "#64748b", marginTop: 2 }}>
          Tambahkan banyak siswa sekaligus menggunakan file Excel. Nomor absen akan diurutkan otomatis secara alfabetis per kelas.
        </p>
      </div>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
          <div>
            ...
            <p style={{ fontSize: 12, color: "#64748b", marginTop: 4, lineHeight: 1.5 }}>
              Isi kolom <strong>Nama Siswa, NIS, Jenis Kelamin, Kelas</strong>. Kolom Jenis Kelamin
              dan Kelas sudah berupa dropdown agar tidak salah ketik.
            </p>
          </div>
          <button
            type="button"
      ...
      <div style={cardStyle}>
        ...
        <p style={{ fontSize: 12, color: "#64748b", marginTop: 0, marginBottom: 16, lineHeight: 1.5 }}>
          Baris dengan data tidak valid akan dilewati dan dilaporkan, baris lain yang valid tetap diimport.
        </p>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            />
            {fileName && (
              <span style={{ fontSize: 11, color: "#6366f1" }}>{fileName}</span>
            )}
          </div>
      ...
      {result && (
        <div style={cardStyle}>
          ...
          <div style={{
            padding: "10px 14px", borderRadius: 10, fontSize: 12, marginBottom: result.errors?.length ? 16 : 0,
              ...
              {result.errors.map((err, idx) => (
                <div
                  ...
                  style={{
                    ...
                    background: "rgba(239,68,68,0.05)", border: "0.5px solid rgba(239,68,68,0.15)",
                    fontSize: 12,
                  }}
                >
                  <span style={{ fontWeight: 700, color: "#dc2626", flexShrink: 0 }}>
                    Baris {err.baris}
                  </span>
